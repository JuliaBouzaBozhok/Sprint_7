...
public class Order {
    ...
    public static Order createOrderWithColor(List<String> colorScooter) {
        String firstNameOrder = "Major";
        String lastNameOrder = "Kusanagi";
        String address = "Tokyo, 24 home";
        int metroStation = 3;
        String phone = "+7 800 000 22 32";
        int rentTime = 2;
        String deliveryDate = "2022-01-01";
        String comment = "What If A Cyber Brain Could Possibly Generate Its Own Ghost, Create A Soul All By Itself? " +
                "And If It Did, Just What Would Be The Importance Of Being Human Then?";

        return new Order (firstNameOrder,lastNameOrder,address,metroStation,phone,rentTime,deliveryDate,comment, colorScooter);
    }
